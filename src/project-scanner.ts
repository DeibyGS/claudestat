...
<!-- Auto-generated by claudestat. Fill in the TODO sections. -->

## Current Status
- Branch: \`TODO — indicate main branch\`
- Last: auto-generated by claudestat (${stats.session_count} session${stats.session_count !== 1 ? 's' : ''} · $${cost} · ${tokens} tokens)
- State: detected stack: ${stackStr}

## Pending Tasks
- [ ] TODO — describe the next concrete task
- [ ] TODO — add project goals

## Completed
- [x] Project detected and registered by claudestat

## Gotchas
- TODO — note important decisions, known bugs, constraints

## Session Log
- **${new Date().toISOString().slice(0, 10)}** — HANDOFF auto-generated by claudestat with ${stats.session_count} session${stats.session_count !== 1 ? 's' : ''} and $${cost} accumulated cost
`
